  ...
  $sql2 = "INSERT INTO `2fa`(`OTP`) VALUES (md5('$otp'))";
   ...
   mysqli_query($conn, $sql2);
            ...
            //Compose and Send Email
                ...
                $mail->SMTPAuth = 'true';
                $mail->Username = 'wambuinjuguini06@gmail.com'; 
                $mail->Password = 'yylkpwzgefiuqsvf'; 
                $mail->SMTPSecure = 'ssl';
                $mail->Port = 465;

                $mail->setFrom('wambuinjuguini06@gmail.com'); 
                $mail->addAddress($email); 
                $mail->isHTML(true);
                $mail->Subject = 'Flower Shop Management System - OTP Password for Login';
                $mail->Body = 'Dear Esteemed Client, '. $fname . ',

                We truly appreciate you for choosing Flower Shop, as your trusted source for beautiful and fresh flowers. Below is your OTP for login attempt at ' .  date("Y-m-d h:i:s") . ', it expires in 3 minutes:
                <br>
                <br>
                <p><b>' . $otp . '</b></p>
                <br>
                ...
                <br>
                Kind Regards,
                Flower Shop Management System Team.';
  ...
  $sql2 = "INSERT INTO `2fa`(`OTP`) VALUES (md5('$otp'))";
   ...
   mysqli_query($conn, $sql2);
            ...
            //Compose and Send Email
                ...
                $mail->addAddress($email); 
                $mail->isHTML(true);
                $mail->Subject = 'Flower Shop Management System - OTP Password for Reset Credentials';
                $mail->Body = 'Dear Esteemed Client, '. $fname . ',

                We truly appreciate you for choosing Flower Shop, as your trusted source for beautiful and fresh flowers. Below is your OTP for resetting your credentials attempt at ' .  date("Y-m-d h:i:s") . ', it expires in 3 minutes:
                <br>
                <br>
                <p><b>' . $otp . '</b></p>
                <br>
                <br>
                If you did not request this Update My Details attempt, kindly ignore this email.
                <br>
                <br>
                Kind Regards,
                Flower Shop Management System Team.';
