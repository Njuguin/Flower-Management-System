...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Flower Shop - One Time Password Page</title>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo"> <a href="index.html"><img src="images/logo.png" alt="#" style="width: 170px;"></a> </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 ...
                                 <li><a href="plants.html">Plant</a></li>
                     ...
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-caption ">
                              <h1>Elevate Every Occasion <strong class="color">with Exquisite Blooms</strong></h1>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-caption ">
                              <h1>Fresh Flowers Delivered <strong class="color">to Your Doorstep</strong></h1>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-caption ">
                              <h1>Experience the Art <strong class="color">of Floral Design</strong></h1>
            ...
            <div class="row">
               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 paddimg-right">
                  <div class="row">
                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <form action="php/login.php" method="POST">
                           <div class="row">
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                 <input class="form-control" placeholder="Password" type="password" name="itp" required>
                                                   <?php
                  ...
                  ?>
                              ...
                              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                               <button type="submit" name="login" class="abtn">Verify</button>
                              </div>
                           </div>
                        </form>
                     </div>
